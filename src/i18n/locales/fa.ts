...
export const STRINGS_FA = {
    ...
    settings: {
        ...
        items: {
            ...
            toolbarButtons: {
                name: 'دکمه‌های نوار ابزار (همگام‌سازی نمی‌شود)',
            ...
            paneTransitionDuration: {
                name: 'انیمیشن پنل تکی (همگام‌سازی نمی‌شود)',
            ...
            showCalendar: {
                name: 'نمایش تقویم (همگام‌سازی نمی‌شود)',
            ...
            calendarWeeksToShow: {
                name: 'هفته‌های نمایش داده شده (همگام‌سازی نمی‌شود)',
            ...
            navIndent: {
                name: 'تورفتگی درخت (همگام‌سازی نمی‌شود)',
                desc: 'عرض تورفتگی را برای پوشه‌ها و برچسب‌های تودرتو تنظیم کنید.'
            },
            navItemHeight: {
                name: 'ارتفاع آیتم (همگام‌سازی نمی‌شود)',
                desc: 'ارتفاع پوشه‌ها و برچسب‌ها را در پنل ناوبری تنظیم کنید.'
            },
            navItemHeightScaleText: {
                name: 'مقیاس‌بندی متن با ارتفاع آیتم (همگام‌سازی نمی‌شود)',

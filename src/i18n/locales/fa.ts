...
export const STRINGS_FA = {
    ...
    navigationCalendar: {
        ...
        helpModal: {
            ...
            items: [
                ...
                '`Cmd/Ctrl+Click` روی تاریخ برای افزودن آن به عنوان فیلتر جستجو. `Option/Alt+Click` نیز هنگامی که اصلاح‌کننده گزینه در تنظیمات فعال است کار می‌کند.'
            ]
        }
    },
    ...
    searchInput: {
        ...
        searchHelpModal: {
            intro: 'نام فایل‌ها، برچسب‌ها و تاریخ‌ها را در یک جستجو ترکیب کنید (مثال: `meeting #work @thisweek`). افزونه Omnisearch را نصب کنید تا از جستجوی متن کامل استفاده کنید.',
            ...
            sections: {
                ...
                connectors: {
                    ...
                    items: [
                        ...
                        'اگر جستجو شامل نام‌ها، تاریخ‌ها (`@...`) یا فیلترهای وظیفه (`has:task`) باشد، `AND` و `OR` به عنوان کلمه جستجو می‌شوند.',
                        'مثال جستجوی عملگری: `#work OR #home`.',
                        'مثال جستجوی ترکیبی: `#work OR has:task` (`OR` در نام فایل‌ها جستجو می‌شود).'
                    ]
                },
                dates: {
                    title: 'تاریخ‌ها',

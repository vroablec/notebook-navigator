    ...
    settings: {
        ...
        items: {
            ...
            optimizeNoteHeight: {
                ...
                desc: 'ارتفاع را برای یادداشت‌های سنجاق‌شده و یادداشت‌های بدون متن پیش‌نمایش کاهش دهید.'
            },
            compactItemHeight: {
            ...
            showFeatureImage: {
                ...
                desc: 'تصاویر بندانگشتی از فرانت‌متر نمایش دهید. نکته: از افزونه "Featured Image" برای تنظیم خودکار تصاویر ویژه برای همه اسناد استفاده کنید.'
            },
            ...
            featureImageProperties: {
                ...
                desc: 'لیست ویژگی‌های فرانت‌متر جدا شده با کاما برای بررسی تصاویر بندانگشتی. اولین ویژگی با تصویر استفاده می‌شود. اگر خالی باشد و تنظیم بازگشتی فعال باشد، اولین تصویر جاسازی‌شده استفاده می‌شود.',
                placeholder: 'بندانگشتی، تصویر'
            },
            useEmbeddedImageFallback: {
                name: 'استفاده از تصویر جاسازی‌شده بازگشتی',
                desc: 'از اولین تصویر جاسازی‌شده در سند به عنوان بازگشتی استفاده کنید وقتی بندانگشتی در ویژگی‌های فرانت‌متر یافت نشود (نیاز به اوبسیدین ۱.۹.۴+ دارد). برای تأیید تنظیم صحیح بندانگشتی‌ها این را غیرفعال کنید.'
            },
            showRootFolder: {

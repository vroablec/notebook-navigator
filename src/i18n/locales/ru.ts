...
export const STRINGS_RU = {
    ...
    settings: {
        ...
        items: {
            ...
            compactItemHeight: {
                name: 'Высота компактных элементов (не синхронизируется)',
            ...
            compactItemHeightScaleText: {
                name: 'Масштабировать текст с высотой компактных элементов (не синхронизируется)',
            ...
            toolbarButtons: {
                name: 'Кнопки панели инструментов (не синхронизируется)',
            ...
            paneTransitionDuration: {
                name: 'Анимация одиночной панели (не синхронизируется)',
            ...
            showCalendar: {
                name: 'Показать календарь (не синхронизируется)',
            ...
            calendarWeeksToShow: {
                name: 'Недель для отображения (не синхронизируется)',
            ...
            navIndent: {
                name: 'Отступ дерева (не синхронизируется)',
                desc: 'Настройте ширину отступа для вложенных папок и тегов.'
            },
            navItemHeight: {
                name: 'Высота элемента (не синхронизируется)',
                desc: 'Настройте высоту папок и тегов в панели навигации.'
            },
            navItemHeightScaleText: {
                name: 'Масштабировать текст с высотой элемента (не синхронизируется)',

...
export const STRINGS_UK = {
    ...
    settings: {
        ...
        items: {
            ...
            compactItemHeight: {
                name: 'Висота компактних елементів (не синхронізується)',
            ...
            compactItemHeightScaleText: {
                name: 'Масштабувати текст з висотою компактних елементів (не синхронізується)',
            ...
            toolbarButtons: {
                name: 'Кнопки панелі інструментів (не синхронізується)',
            ...
            paneTransitionDuration: {
                name: 'Анімація однієї панелі (не синхронізується)',
            ...
            showCalendar: {
                name: 'Показати календар (не синхронізується)',
            ...
            calendarWeeksToShow: {
                name: 'Тижнів для показу (не синхронізується)',
            ...
            navIndent: {
                name: 'Відступ дерева (не синхронізується)',
                desc: 'Налаштувати ширину відступу для вкладених папок і тегів.'
            },
            navItemHeight: {
                name: 'Висота елемента (не синхронізується)',
                desc: 'Налаштувати висоту папок і тегів у панелі навігації.'
            },
            navItemHeightScaleText: {
                name: 'Масштабувати текст з висотою елемента (не синхронізується)',

    ...
    settings: {
        ...
        items: {
            ...
            optimizeNoteHeight: {
                ...
                desc: 'تقليل الارتفاع للملاحظات المثبتة والملاحظات بدون نص معاينة.'
            },
            compactItemHeight: {
            ...
            featureImageProperties: {
                name: 'خصائص الصورة',
                desc: 'قائمة مفصولة بفاصلة من خصائص البيانات الأمامية للتحقق من الصور المصغرة. سيتم استخدام أول خاصية تحتوي على صورة. إذا كانت فارغة وكان إعداد البديل ممكّنًا، سيتم استخدام أول صورة مضمنة.',

    ...
    navigationCalendar: {
        ...
        helpModal: {
            ...
            items: [
                ...
                '`Cmd/Ctrl+Click` على تاريخ لإضافته كمرشح بحث. `Option/Alt+Click` يعمل أيضًا عند تفعيل مُعدِّل الخيار في الإعدادات.'
            ]
        }
    },
            ...
            sections: {
                ...
                connectors: {
                    ...
                    items: [
                        ...
                        'إذا تضمن الاستعلام أسماء أو تواريخ (`@...`) أو مرشحات مهام (`has:task`)، يتم مطابقة `AND` و `OR` ككلمات.',
                        'مثال على استعلام بعوامل: `#work OR #home`.',
                        'مثال على استعلام مختلط: `#work OR has:task` (يتم مطابقة `OR` في أسماء الملفات).'
                    ]
                },
                dates: {
                    title: 'التواريخ',

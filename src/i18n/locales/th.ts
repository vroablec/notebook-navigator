...
export const STRINGS_TH = {
    ...
    navigationCalendar: {
        ...
        helpModal: {
            ...
            items: [
                ...
                '`Cmd/Ctrl+Click` ที่วันที่เพื่อเพิ่มเป็นตัวกรองการค้นหา `Option/Alt+Click` ก็ใช้ได้เช่นกันเมื่อเปิดใช้ตัวปรับแต่งตัวเลือกในการตั้งค่า'
            ]
        }
    },
    ...
    searchInput: {
        ...
        searchHelpModal: {
            intro: 'รวมชื่อไฟล์ แท็ก และวันที่ในคำค้นหาเดียว (เช่น `meeting #work @thisweek`) ติดตั้งปลั๊กอิน Omnisearch เพื่อใช้การค้นหาข้อความเต็ม',
            ...
            sections: {
                ...
                connectors: {
                    ...
                    items: [
                        ...
                        'หากคิวรีรวมชื่อ วันที่ (`@...`) หรือตัวกรองงาน (`has:task`) `AND` และ `OR` จะถูกค้นหาเป็นคำ',
                        'ตัวอย่างคิวรีตัวดำเนินการ: `#work OR #home`',
                        'ตัวอย่างคิวรีผสม: `#work OR has:task` (`OR` ถูกค้นหาในชื่อไฟล์)'
                    ]
                },
                dates: {
                    title: 'วันที่',

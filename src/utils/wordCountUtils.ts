...
// Obsidian uses a BMP-only letter class (gF). This source mirrors that letter class and
// intentionally excludes CJK ideographs and Mathematical Alphanumeric Symbols.
const OBSIDIAN_GF_PATTERN_SOURCE =
